...
Route::get('restaurants/near/{slug}', 'RestaurantsController@restaurants_near');
...
Route::get('restaurants/restaurants_distance', 'RestaurantsController@restaurants_distance');
...
Route::get('/googlemap', 'App\Http\Controllers\MapController@map')->name('map');
