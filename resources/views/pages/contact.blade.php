...
@section('head_title', 'Liên Hệ | '.getcong('site_name') )
    ...
    <div class="contact-form">
      <div class="col-sm-6">                
        ...
        @endif      
          ...
          <ul class="row">
            <li class="col-sm-6">
              <label class="font-montserrat">Tên Của Bạn <span class="required">*</span>
                <input type="text" class="form-control" name="name" id="name" placeholder="">
              </label>
            </li>
            <li class="col-sm-6">
              <label class="font-montserrat"> Email Của Bạn <span class="required">*</span>
                <input type="text" class="form-control" name="email" id="email" placeholder="">
              </label>
            </li>
            <li class="col-sm-6">
              <label class="font-montserrat">Số Điện Thoại 
                <input type="text" class="form-control" name="phone" id="phone" placeholder="">
              </label>
            </li>
            <li class="col-sm-6">
              <label class="font-montserrat">Chủ Đề
                <input type="text" class="form-control" name="subject" id="subject" placeholder="">
              </label>
            </li>
            <li class="col-sm-12">
              <label class="font-montserrat">Lời Nhắn
                <textarea class="form-control" name="message" id="message" rows="5" placeholder=""></textarea>
              </label>
            </li>
            
            <li class="col-sm-8">
              <button type="submit" value="submit" class="btn font-montserrat" id="btn_submit" onClick="proceed();">Gửi</button>
            </li>
          </ul>
        {!! Form::close() !!}
      </div>
