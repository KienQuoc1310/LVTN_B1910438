...
<span aria-hidden="true">&times;</span></button>
				...
				<span aria-hidden="true">&times;</span></button>
                        ...
                        <div class="form-group">
                            <label for="email">Làm mới mật khẩu</label>
                            <input type="email" class="form-control" name="email" id="email" placeholder="Enter email">
                        </div>
                       <div class="form-group">                            
                            <a href="{{ URL::to('admin/') }}" class="small pull-right">Đăng nhập?</a>
                             
                        </div>
                         
                    </div>
                    <div class="form-group text-center">
                        <button type="submit" class="btn btn-primary">Làm mới <i class="md md-lock-open"></i></button>
                    </div>
                {!! Form::close() !!} 
            </div>
