               ...
               <!-- <div class="avatar">
				...
				<span aria-hidden="true">&times;</span></button>
                        ...
                        <div class="form-group margin-none">
                            <div class="media">
                                ...
                                <div class="media-right media-middle">
                                    <a href="{{ URL::to('admin/password/email') }}" class="small pull-right">Quên mật khẩu?</a>
                                </div>
                            </div>
                        ...
                        <div class="form-group checkbox">                            
                            ...
                            <label for="checkbox1">Ghi nhớ tài khoản này</label>
                             
                        </div>
                    </div>
                    <div class="form-group text-center">
                        <button type="submit" class="btn btn-primary">Đăng nhập <i class="md md-lock-open"></i></button>
                    </div>
                {!! Form::close() !!} 
            </div>
