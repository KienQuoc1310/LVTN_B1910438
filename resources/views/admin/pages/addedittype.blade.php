...
<div id="main">
	<div class="page-header">
		<h2> {{ isset($type->type) ? 'Edit: '. $type->type : 'Thêm Loại' }}</h2>
		
		<a href="{{ URL::to('admin/types') }}" class="btn btn-default-light btn-xs"><i class="md md-backspace"></i>Quay Lại</a>
	...
	@endif
   	...
   	<div class="panel panel-default">
            <div class="panel-body">
                ...
                <div class="form-group">
                    <label for="avatar" class="col-sm-3 control-label">Loại Hình Ảnh</label>
                    <div class="col-sm-9">
                        <div class="media">
                ...
                <div class="form-group">
                    <div class="col-md-offset-3 col-sm-9 ">
                    	<button type="submit" class="btn btn-primary">{{ isset($type->id) ? 'Chỉnh Sửa Loại ' : 'Thêm Loại' }}</button>
