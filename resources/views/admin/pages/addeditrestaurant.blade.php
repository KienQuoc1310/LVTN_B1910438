...
<div id="main">
	<div class="page-header">
		<h2> {{ isset($restaurant->restaurant_name) ? 'Edit: '. $restaurant->restaurant_name : 'Thêm Nhà Hàng' }}</h2>
		
		<a href="{{ URL::to('admin/restaurants') }}" class="btn btn-default-light btn-xs"><i class="md md-backspace"></i>Quay Lại</a>
   	...
   	<div class="panel panel-default">
            <div class="panel-body">
                ...
                <div class="form-group">
                    <label for="" class="col-sm-3 control-label">Loại Nhà Hàng</label>
                    <div class="col-sm-9">
                ...
                <div class="form-group">
                    <label for="" class="col-sm-3 control-label">Tên Nhà Hàng</label>
                      <div class="col-sm-9">
                ...
                <div class="form-group">
                    <label for="" class="col-sm-3 control-label">Đường Dẫn </label>
                    <div class="col-sm-9">
                ...
                <div class="form-group">
                 ...
                 <div class="form-group">
                    <label for="avatar" class="col-sm-3 control-label">Logo Nhà Hàng</label>
                    <div class="col-sm-9">
                        <div class="media">
                ...
                <div class="form-group">
                    <label for="" class="col-sm-3 control-label">Mapurl</label>
                    <div class="col-sm-9">
                        <textarea name="restaurant_mapurl" id="restaurant_mapurl" cols="60" rows="3" class="form-control">{{ isset($restaurant->restaurant_mapurl) ? $restaurant->restaurant_mapurl : null }}</textarea>
                    </div>
                </div>

                <div class="form-group">
                    <label for="" class="col-sm-3 control-label">Lat</label>
                    <div class="col-sm-9">
                        <input type="text" name="restaurant_maplat"  value="{{ isset($restaurant->restaurant_maplat) ? $restaurant->restaurant_maplat: null }}" class="form-control">
                    </div>
                </div>
                
                <div class="form-group">
                    <label for="" class="col-sm-3 control-label">Long</label>
                    <div class="col-sm-9">
                        <input type="text" name="restaurant_maplong"  value="{{ isset($restaurant->restaurant_maplong) ? $restaurant->restaurant_maplong: null }}" class="form-control">
                    </div>
                </div>

                <div class="form-group">
                    <label for="" class="col-sm-3 control-label">Distance</label>
                    <div class="col-sm-9">
                        <input type="text" name="restaurant_distance"  value="{{ isset($restaurant->restaurant_distance) ? $restaurant->restaurant_distance: null }}" class="form-control">
                    </div>
                </div>
                ...
                <div class="form-group">
                    <div class="col-md-offset-3 col-sm-9 ">
                    	<button type="submit" class="btn btn-primary">{{ isset($restaurant->id) ? 'Chỉnh Sửa Nhà Hàng' : 'Thêm Nhà Hàng' }}</button>
