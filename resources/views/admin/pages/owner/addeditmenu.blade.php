...
<div id="main">
	<div class="page-header">
		<h2> {{ isset($menu->menu_name) ? 'Edit: '. $menu->menu_name : 'Thêm Món Vào Thực Đơn' }}</h2>
		
		<a href="{{ URL::to('admin/menu') }}" class="btn btn-default-light btn-xs"><i class="md md-backspace"></i>Quay Lại</a>
   	...
   	<div class="panel panel-default">
            <div class="panel-body">
                ...
                <div class="form-group">
                    <label for="" class="col-sm-3 control-label">Danh Sách Món</label>
                    <div class="col-sm-4">
                ...
                <div class="form-group">
                    <label for="" class="col-sm-3 control-label">Tên Món</label>
                      <div class="col-sm-9">
                ...
                <div class="form-group">
                    <label for="" class="col-sm-3 control-label">Giá</label>
                      <div class="col-sm-9">
                        ...
                        <input id="touch-spin-2" data-toggle="touch-spin" data-min="-1000000" data-max="1000000" data-prefix="VNĐ" data-step="1" type="text" value="{{ isset($menu->price) ? $menu->price : null }}" name="price" class="form-control"/>
                    </div>
                </div>
                <div class="form-group">
                    <label for="avatar" class="col-sm-3 control-label">Hình ảnh Món</label>
                    <div class="col-sm-9">
                        <div class="media">
                ...
                <div class="form-group">
                    <div class="col-md-offset-3 col-sm-9 ">
                    	<button type="submit" class="btn btn-primary">{{ isset($menu->id) ? 'Chỉnh sửa Món ' : 'Thêm Món' }}</button>
