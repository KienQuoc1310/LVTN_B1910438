...
<span aria-hidden="true">&times;</span></button>
    ...
    <ul class="nav nav-tabs" role="tablist">
        ...
        <!-- <li role="presentation">
            <a href="#about_widget" aria-controls="about_widget" role="tab" data-toggle="tab">Giới Thiệu</a>
        </li>         -->
        <li role="presentation">
            <a href="#followus" aria-controls="followus" role="tab" data-toggle="tab">Mạng Xã Hội</a>
        </li>
        <!-- <li role="presentation">
            <a href="#need_help" aria-controls="need_help" role="tab" data-toggle="tab">Trợ Giúp</a>
        </li>                -->
    ...
    <div class="tab-content tab-content-default">
        <div role="tabpanel" class="tab-pane active" id="footer_widgets">             
            {!! Form::open(array('url' => 'admin/footer_widgets','class'=>'form-horizontal padding-15','name'=>'about_contact_widgets_form','id'=>'about_contact_widgets_form','role'=>'form','enctype' => 'multipart/form-data')) !!}
                ...
                <div class="form-group">
                    <label for="" class="col-sm-3 control-label">Widget 1 Tiêu Đề</label>
                    <div class="col-sm-9">
                        <input type="text" name="footer_widget1_title" value="{{ $widgets->footer_widget1_title }}" class="form-control" value="">
                    </div>
                </div>                
                <div class="form-group">
                    <label for="" class="col-sm-3 control-label">Widget 1 Mô Tả</label>
                    <div class="col-sm-9">
                        <textarea type="text" name="footer_widget1_desc" class="form-control" rows="5" placeholder="Một vài từ miêu tả">{{ $widgets->footer_widget1_desc }}</textarea>
                    </div>
                </div>
                <hr>
                <div class="form-group">
                    <label for="" class="col-sm-3 control-label">Widget 2 Tiêu Đề</label>
                    <div class="col-sm-9">
                        <input type="text" name="footer_widget2_title" value="{{ $widgets->footer_widget2_title }}" class="form-control" value="">
                    </div>
                </div>                
                <div class="form-group">
                    <label for="" class="col-sm-3 control-label">Widget 2 Mô Tả</label>
                    <div class="col-sm-9">
                        <textarea type="text" name="footer_widget2_desc" class="form-control" rows="5" placeholder="Một vài từ miêu tả">{{ $widgets->footer_widget2_desc }}</textarea>
                    </div>
                </div>
                <hr>
                <div class="form-group">
                    <label for="" class="col-sm-3 control-label">Widget 3 Tiêu Đề</label>
                    <div class="col-sm-9">
                        <input type="text" name="footer_widget3_title" value="{{ $widgets->footer_widget2_title }}" class="form-control" value="">
                    </div>
                </div>                
                <div class="form-group">
                    <label for="" class="col-sm-3 control-label">Widget 3 Địa Chỉ</label>
                    <div class="col-sm-9">
                        <textarea type="text" name="footer_widget3_address" class="form-control" rows="5" placeholder="Một vài từ miêu tả">{{ $widgets->footer_widget3_address }}</textarea>
                    </div>
                </div>
                <div class="form-group">
                    <label for="" class="col-sm-3 control-label">Widget 3 Số Điện Thoại</label>
                    <div class="col-sm-9">
        ...
        <!-- <div role="tabpanel" class="tab-pane" id="about_widget">             
            {!! Form::open(array('url' => 'admin/about_widgets','class'=>'form-horizontal padding-15','name'=>'about_contact_widgets_form','id'=>'about_contact_widgets_form','role'=>'form','enctype' => 'multipart/form-data')) !!}
                ...
                <div class="form-group">
                    <label for="" class="col-sm-3 control-label">Giới Thiệu: Tiêu Đề</label>
                    <div class="col-sm-9">
                        <input type="text" name="about_title" value="{{ $widgets->about_title }}" class="form-control" value="">
                    </div>
                </div>                
                <div class="form-group">
                    <label for="" class="col-sm-3 control-label">Giới Thiệu: Trang Web</label>
                    <div class="col-sm-9">
        ...
        <!-- <div role="tabpanel" class="tab-pane" id="need_help">
            ...
            {!! Form::open(array('url' => 'admin/need_help','class'=>'form-horizontal padding-15','name'=>'need_help_form','id'=>'need_help_form','role'=>'form')) !!}
                ...
                <div class="form-group">
                    <label for="" class="col-sm-3 control-label">Trợ Giúp: Tiêu Đề</label>
                    <div class="col-sm-9">
