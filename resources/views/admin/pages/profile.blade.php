...
<span aria-hidden="true">&times;</span></button>
    ...
    <ul class="nav nav-tabs" role="tablist">
        <li role="presentation" class="active">
            <a href="#account" aria-controls="account" role="tab" data-toggle="tab">Tài Khoản</a>
        </li>
        <li role="presentation">
            <a href="#ac_password" aria-controls="ac_password" role="tab" data-toggle="tab">Mật Khẩu</a>
        </li>        
        </li>
    </ul>
    ...
    <div class="tab-content tab-content-default">
        <div role="tabpanel" class="tab-pane active" id="account">             
            {!! Form::open(array('url' => 'admin/profile','class'=>'form-horizontal padding-15','name'=>'account_form','id'=>'account_form','role'=>'form','enctype' => 'multipart/form-data')) !!}
                ...
                <div class="form-group">
                    <label for="avatar" class="col-sm-3 control-label">Ảnh Người Dùng</label>
                    <div class="col-sm-9">
                        <div class="media">
        ...
        <div role="tabpanel" class="tab-pane" id="ac_password">
            ...
            {!! Form::open(array('url' => 'admin/profile_pass','class'=>'form-horizontal padding-15','name'=>'pass_form','id'=>'pass_form','role'=>'form')) !!}
                ...
                <div class="form-group">
                    <label for="" class="col-sm-3 control-label">Xác Nhận Mật Khẩu</label>
                    <div class="col-sm-9">
