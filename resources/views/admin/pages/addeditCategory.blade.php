...
<div id="main">
	<div class="page-header">
		<h2> {{ isset($cat->category_name) ? 'Edit: '. $cat->category_name : 'Thêm Danh Mục' }}</h2>
		
		<a href="{{ URL::to('admin/restaurants/view/'.$restaurant_id.'/categories') }}" class="btn btn-default-light btn-xs"><i class="md md-backspace"></i>Quay Lại</a>
            ...
            <div class="panel-body">
                ...
                <div class="form-group">
                    <div class="col-md-offset-3 col-sm-9 ">
                    	<button type="submit" class="btn btn-primary">{{ isset($cat->id) ? 'Chỉnh Sửa Danh Mục' : 'Thêm Danh Mục' }}</button>
