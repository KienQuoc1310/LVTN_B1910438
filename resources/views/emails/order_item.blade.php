...
<div style="width: 1100px;margin:0 auto;">    
<h2 style="color: #565656;font-size: 14px;font-weight: 600;padding:5px 10px;text-align:left;">Xin Chào {{$name}},</h2>
<p style="padding:0 10px;margin: 0 0 10px;line-height:22px;color:#444">Cảm Ơn Bạn Đã Đặt Hàng!</p> 
