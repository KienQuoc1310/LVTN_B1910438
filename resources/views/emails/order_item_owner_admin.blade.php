...
<p style="padding:0 10px;margin: 0 0 10px;line-height:22px;color:#444">Đơn Hàng Mới Đã Được Đặt Bởi {{$name}}!</p> 
	...
	<table height="100%" width="100%">
	  ...
	  <tbody>
		...
		<tr style="border-bottom:1px solid #ccc">                      
		  ...
		  <td style="width:12%;color:#565656;text-align:left;padding:10px;vertical-align: middle;">{{ \App\Menu::getMenunfo($order->item_id)->price }} {{getcong('currency_symbol')}}</td>
		  <td style="width:38%;color:#565656;text-align:left;padding:10px;vertical-align: middle;">	{{$order->item_price}} {{getcong('currency_symbol')}}
