...
class CategoriesController extends MainAdminController
{
    ...
    public function owner_editCategory($menu_id)    
    {     
        ...
        $categories = Menu::findOrFail($categories_id);
          
       

           

          return view('admin.pages.owner.addeditCategory',compact('categories','restaurant_id'));
