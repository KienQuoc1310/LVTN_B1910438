...
class RestaurantsController extends MainAdminController
{
    ...
    { 
        ...
        $restaurant_obj->restaurant_mapurl = $inputs['restaurant_mapurl'];
        $restaurant_obj->restaurant_maplat = $inputs['restaurant_maplat'];
        $restaurant_obj->restaurant_maplong = $inputs['restaurant_maplong'];
